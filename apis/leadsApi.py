...
class LeadsApi(BaseApi):
    ...
    def getLeads_D1(self):
        ...
        params.append(["lead_created_after", "2023-10-01"])
        params.append(["lead_created_before", "2023-11-01"])
        params.append(["lead_updated_after", "2023-10-01"])
        params.append(["lead_updated_before", "2023-11-01"])
